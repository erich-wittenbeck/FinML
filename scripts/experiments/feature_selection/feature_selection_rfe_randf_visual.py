...
for span in spans:
    ...
    for matrix in matrices:
        ...
        for feature in selection_timelines:
            selection_timelines[feature] += [1 if feature in randf.features else 0]
    ...
    plt.title(span + 's')
    plt.savefig('/home/files/output/png/randf/feature_selection_rfe_randf_'+span+'s.png', dpi=300, bbox_inches="tight")
    plt.clf()