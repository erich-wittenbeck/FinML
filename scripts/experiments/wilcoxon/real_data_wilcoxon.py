...
table_f1 = pd.DataFrame(wil_dict_f1).to_latex(buf='/home/files/output/latex/real_data_wilcoxon_f1.txt')
table_auc = pd.DataFrame(wil_dict_auc).to_latex(buf='/home/files/output/latex/real_data_wilcoxon_auc.txt')
